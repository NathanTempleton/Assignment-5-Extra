...
print("Welcome to my calculator, here you can can calculate the circumference or area of a circle.")
playerChoice = input("Would you like to calculate the area or the circumference of the circle: ")
